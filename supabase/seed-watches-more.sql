...
from wl, (values
  ...
  ('Clover Leaf tuna',                    1.29::numeric, 'clover leaf',    null::text,                                                                null::text,                                                    18),
  ('2% milk 2L',                          4.49::numeric, 'milk',           'almond, oat, soy, coconut, whitener, international delight, chocolate, evaporated, condensed', null::text,                        19)
